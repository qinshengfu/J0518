								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.ACTUAL_TOTAL}</td>
											<c:if test="${var.PAY_TYPE == 1}">
												<td class='center'>积分</td>
											</c:if>
											<c:if test="${var.PAY_TYPE == 0}">
											...
											<td class='center'>${var.PRODUCT_SUM}</td>
