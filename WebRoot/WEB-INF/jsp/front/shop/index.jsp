...
<div class="mui-content">
    ...
    <div class="search_shop">
        <div class="flex"><input type="search" id="keywords" placeholder="输入关键词搜索"><i onclick="startSearch()"
                                                                                      class="iconfont icon-search1"></i>
        </div>
    </div>
    <!-- 轮播图 -->
    ...
    <!-- 热销产品 -->
    <div class="shop_tit"><span></span>热销产品</div>
    <!-- 商品展示 -->
    <div class="pic_list mescroll" id="mescroll">
        <ul class="mui-table-view mui-grid-view" id="dataList">
...
<script type="text/javascript">
    ...
    // 商城轮播图
    function getMallChart() {
        $.get("release/mallChart", function (result) {
            if (result.success) {
                // 设置轮播图内容
                setMallChart(result.data.item)
            }
        }, "json")
    }

    // 设置轮播图
    function setMallChart(data) {
        // 获取父节点
...
<script type="text/javascript" charset="utf-8">
    ...
    $(function () {
        ...
        function getListData(page) {
            ...
            //联网加载数据
            getListDataFromNet(page.num, page.size, key, function (data) {
        ...
        function setListData(curPageData) {
            ...
            for (var i = 0; i < curPageData.length; i++) {
                ...
                str += "<li class=\"mui-table-view-cell mui-media mui-col-xs-6\">\n" +
                    "                <a href=\"release/to_mallShopdetail/" + pd.PROD_ID + "\">\n" +
                    "                    <img class=\"mui-media-object\" src=\"" + getLoading() + "\" imgurl=\"" + pd.PIC + "\" >\n" +
                    "                    <div class=\"mui-media-body\">" + pd.PROD_NAME + "</div>\n" +
                    "                    <div class=\"pic_list_div\">\n" +
                    "                        <div>\n" +
        ...
        /*联网加载列表数据
         * */
        function getListDataFromNet(pageNum, pageSize, keywords, successCallback, errorCallback) {

            var url = 'release/getProdList.do?currentPage=' + pageNum + "&showCount=" + pageSize + "&keywords=" + keywords;
