...
<script type="text/javascript" charset="utf-8">
    ...
    $(function () {
        ...
        function setListData(curPageData) {
            ...
            for (var i = 0; i < curPageData.length; i++) {
                ...
                str += "<div class=\"order_list dfk\">\n" +
                    ...
                    "        </div>\n" +
                    "        <a href=\"front/to_goodsDetail/" + pd.DELIVERY_RECORD_ID + "\">\n" +
                    "            <div class=\"order_txt\">\n" +
                    "                <div class=\"order_txt_1\">" +
                    "                   <div class=\"order_txt_pic\">\n";
                str += "     <div class=\"width_pic\">\n" +
                    "            <div class=\"txt-cut\">\n" +
                    "                " + pd.PROD_NAME + "\n" +
                    "            </div>" +
                    "            <div class=\"price\"><span style=\"color: #999;\">价格：</span>￥" + pd.CURRENT_PRICE + "</div>\n" +
                    "        </div>";
                str += "     <p>x" + pd.PROD_NUM + "</p>" +
                    "                </div>" +
                    "               </div>\n" +
                    "            </div>\n" +
                    "        </a>" +
                    ...
                    "        <div class=\"order_bot\">\n" +
                    "            <div>合计:<span>￥" + (pd.CURRENT_PRICE * pd.PROD_NUM) + "</span></di v>";
                ...
                if (pd.STATUS == '待收货') {
                    str += "         <div>\n" +
                        "                <button type=\"button\" class=\"ljfk\"><a onclick='signFor(" + pd.DELIVERY_RECORD_ID + ")'>确认收货</a></button>\n" +
                        "            </div>\n" +
                        "        </div>\n" +
                        "    </div>";
                }
        ...
        function getListDataFromNet(pdType, pageNum, pageSize, successCallback, errorCallback) {
            ...
            var url = 'front/getGoodsRecordList.do?STATUS=' + pdType + '&currentPage=' + pageNum + "&showCount=" + pageSize;
    ...
    function signFor(id) {
        ...
        layer.open({
            ...
            , yes: function (index) {
                layer.close(index);
                var url = "front/goodsConfirm";
                $.post(url, {"DELIVERY_RECORD_ID": id}, function (result) {
