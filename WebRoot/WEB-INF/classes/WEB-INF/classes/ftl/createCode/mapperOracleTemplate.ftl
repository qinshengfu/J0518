...
<mapper namespace="${objectName}Mapper">
	...
	<insert id="save" parameterType="pd">
		...
		/* 返回 主键ID 需要手动创建对应的序列*/
		<selectKey keyProperty="${objectNameUpper}_ID" order="BEFORE" resultType="java.lang.Integer">
			select ${tabletop}${objectNameUpper}_SEQ.NEXTVAL as ${objectNameUpper}_ID from DUAL
		</selectKey>
