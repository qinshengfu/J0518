		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="delivery_record/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="DELIVERY_RECORD_ID" id="DELIVERY_RECORD_ID" value="${pd.DELIVERY_RECORD_ID}"/>
