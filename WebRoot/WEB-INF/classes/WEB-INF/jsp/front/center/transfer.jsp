    ...
    <form id="Form" method="post">
        ...
        <div class="setup_inp">
            <div class="mui-input-row">
                <label>对方手机号：</label>
                <input type="number" id="PHONE" name="PHONE" onblur="checkPhone(this)"
                       oninput="if (value.length > 11) value = value.slice(0,11)"
                       placeholder="请输入对方手机号">
            </div>
            <div class="mui-input-row">
                <label>金额：</label>
                <input type="number" id="num" name="num" placeholder="请输入金额">
            </div>
            <div class="mui-input-row">
                <label>交易密码：</label>
                <input type="password" name="pass" placeholder="请输入交易密码">
            </div>
        </div>
        <button type="button" data-loading-text="提交中" class="mui-btn mui-btn-blue mui-btn-block mui_btn">确认转账</button>
    </form>
    <!-- 转账记录 -->
    <div class="quota_top mescroll" id="mescroll">
...
<script type="text/javascript">
    ...
    function server_verification() {
        var url = "front/transferAccount.do";
    ...
    $(function () {
        ...
        function setListData(curPageData) {
            ...
            for (var i = 0; i < curPageData.length; i++) {
                ...
                str += "<tr>\n" +
                    "      <td>" + pd.GMT_CREATE + "</td>\n" +
                    "      <td>" + pd.WALLET_ADDRESS + "</td>\n" +
                    "      <td>" + pd.TAG + pd.MONEY + "</td>\n" +
                    "   </tr>";
                listDom.append(str);
            }
        }
        ...
        function getListDataFromNet(pageNum, pageSize, successCallback, errorCallback) {
            ...
            var url = 'front/getTransferRecord.do?num=' + pageNum + "&size=" + pageSize;
