...
import com.fh.service.fhim.FriendsManager;
import com.fh.service.fhim.HismsgManager;
import com.fh.service.fhim.ImstateManager;
import com.fh.service.fhim.IQgroupManager;
import com.fh.service.fhim.QgroupManager;
import com.fh.service.fhim.SysmsgManager;
            ...
            try {
                ...
                for (int i = 0; i < varList.size(); i++) {
                    ...
                    if (user.equals(USERNAME))
                        continue;                                                    //不发给本人(群消息的发送者不接收自己发的消息)
